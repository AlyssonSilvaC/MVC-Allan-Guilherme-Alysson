...
module.exports = {
  ...
  const home = (req, res) => {
    return res.sendFile(path.join(`${__dirname}/../views/Navegacao.ejs`));
  };
  module.exports = {
    getHome: home
  };
...
//Para ler as informações do nosso body no html e extrair os dados da tag <form>
...
app.get('/Navegacao', (req, res) => {
    res.render('Navegacao.ejs')
})
